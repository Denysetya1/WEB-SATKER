                    ...
                    Fieldset::make('Feature Image')
                        ->schema([
                            FileUpload::make('cover_photo_path')
                                ...
                                ->hint('Foto ini digunakan di List Berita sebagai Foto Sampul. Direkomendasikan ukuran 1200 x 628')
                                ->image()
                                ->optimize('webp')
                                ->resize(50)
                                ->preserveFilenames()
                                ...
                                ->required(),
                            TextInput::make('photo_alt_text')->label('Keterangan Foto')->required(),
                        ])->columns(1),
                        ...
                        ->schema([
                            Grid::make([
                                ...
                                ToggleButtons::make('status')
                                    ...
                                    ->required()->columnSpan(['default' => 5]),
                                Toggle::make('featured')
                                    ->label('Berita Rekomendasi Teratas?')
                                    ->onColor('success')
                                    ->offColor('danger')
                                    ->inline(false)
                                    ->columnSpan(3),
                                DateTimePicker::make('scheduled_for')
                                    ...
                                    ->native(false)->columnSpan(['default' => 4]),
                            ]),
                        ]),
